  ...
  return (
    <Card 
      className={`relative group h-full ${
        pkg.isPopular 
          ? 'card-featured ring-4 ring-primary-100 bg-gradient-to-b from-white to-primary-25' 
          : 'card-default hover:border-primary-200'
      } hover-lift`}
    >
      {pkg.isPopular && (
        <>
          <div className="absolute -top-5 left-1/2 -translate-x-1/2 z-10">
            <div className="bg-gradient-to-r from-primary-500 to-red-600 text-white font-bold px-5 py-2.5 shadow-xl rounded-xl text-sm flex items-center gap-2">
      ...
      <CardHeader className="flex flex-col items-center pt-10 pb-8 text-center">
        ...
        {pkg.isPopular && (
          <div className="bg-gradient-to-r from-green-400 to-emerald-500 text-white px-4 py-1 rounded-lg text-xs font-bold">
            💰 HEMAT 25%
          </div>
        )}
      </CardHeader>
      
      <CardBody className="flex-1 space-y-6 px-6 md:px-8">
      ...
      <CardFooter className="pt-6 pb-8 flex-col gap-3">
        <Button
          ...
          className={`w-full font-bold text-base ${
            pkg.isPopular
              ? 'btn-primary-large bg-gradient-to-r from-primary-500 to-red-600 hover:from-red-600 hover:to-primary-500'
              : 'btn-primary-large bg-gray-900 hover:bg-primary-500'
          } hover-scale`}
          size="lg"
